...
{
   printk("Calling iotable_init(),  orion5x_io_desc[0].pfn = 0x%08lX, orion5x_io_desc[0].virtual = 0x%08lX, orion5x_io_desc[0].length = %ld\n", 
      orion5x_io_desc[0].pfn, orion5x_io_desc[0].virtual, orion5x_io_desc[0].length);
